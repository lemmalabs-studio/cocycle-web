    ...
    <main className="min-h-screen bg-[#F5F7FA]">
      ...
      <div className="lg:hidden">
        ...
        <div className="px-5 pt-5 pb-32">
          {/* Title & Type Badge */}
          <div className="mb-3">
            <h1 className="text-[#1A2B4A] font-bold text-2xl mb-1">
              {ride.title}
            </h1>
          ...
          <div className="bg-white rounded-2xl overflow-hidden mb-4">
            <div className="flex">
              <div className="flex-1 text-center py-3 border-r border-[#E5E9F0]">
                <svg
                  className="w-6 h-6 text-[#5B7FFF] mx-auto"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-[#1A2B4A] font-bold text-lg mt-1">
            ...
            <div className="flex gap-2 mb-4">
              {ride.inviteOnly && (
                <div className="bg-white rounded-full px-4 py-2 flex items-center">
                  ...
                  <span className="text-[#6B7A90] ml-2 text-sm">
                    Invite Only
                  </span>
                </div>
              )}
          ...
          {/* Meeting Point */}
          <div className="bg-white rounded-2xl p-4 mb-4">
            <h3 className="text-[#1A2B4A] font-semibold text-lg mb-3">
              Meeting Point
            </h3>
          ...
          <div className="mb-4">
            ...
            {otherParticipants.length > 0 ? (
              ...
              <div className="bg-white rounded-2xl p-6 text-center">
                <svg
                  className="w-10 h-10 text-[#9BA8B8] mx-auto"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E5E9F0] p-4 lg:hidden">
          <a
            href={`https://apps.apple.com/au/app/spin-ride-together/id6759232173`}
      ...
      <div className="hidden lg:flex min-h-screen">
        ...
        <div className="w-1/2 p-8 overflow-y-auto">
          <div className="max-w-lg mx-auto">
            ...
            {/* Title & Type Badge */}
            <div className="mb-4">
              <h1 className="text-[#1A2B4A] font-bold text-3xl mb-2">
                {ride.title}
              </h1>
              <div className="flex items-center gap-2">
                <span
                  className={`${getTypeColor()} text-white text-sm font-semibold px-4 py-1.5 rounded-full`}
                >
                  {ride.rideType}
                </span>
                {startsIn && (
            ...
            {/* Description */}
            {ride.description && (
              <p className="text-[#1A2B4A] leading-relaxed mb-6">
                {ride.description}
              </p>
            )}
            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="bg-white rounded-2xl p-4 text-center">
                <svg
                  className="w-6 h-6 text-[#5B7FFF] mx-auto mb-2"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-[#1A2B4A] font-bold text-xl">
                  {formatDistance(ride.distance)}
                </p>
